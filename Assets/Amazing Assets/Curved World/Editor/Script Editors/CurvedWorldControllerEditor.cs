    ...
    namespace CurvedWorldEditor
    {
        ...
        public class CurvedWorldControllerEditor : Editor
        {
            ...
            public override void OnInspectorGUI()
            {
                ...
                using (new AmazingAssets.EditorGUIUtility.GUIEnabled(_target.isActiveAndEnabled))
                {
                    GUILayout.Space(5);
                    ...
                    using (new AmazingAssets.EditorGUIUtility.GUIEnabled(Application.isPlaying == false))
                    {
            ...
            void Draw_PivotPoint()
            {
                ...
                using (new AmazingAssets.EditorGUIUtility.GUIEnabled(bendPivotPoint.objectReferenceValue == null))
                {
            ...
            void Draw_RotationCenter()
            {
                ...
                using (new AmazingAssets.EditorGUIUtility.GUIEnabled(bendRotationCenter.objectReferenceValue == null))
                {
            ...
            void Draw_RotationCenter2()
            {
                ...
                using (new AmazingAssets.EditorGUIUtility.GUIEnabled(bendRotationCenter2.objectReferenceValue == null))
                {
            ...
            void Draw_BendSizeOffset(ref SerializedProperty propSize, ref SerializedProperty propOffset, string axisLabel)
            {
                ...
                EditorGUI.BeginChangeCheck();
                using (new AmazingAssets.EditorGUIUtility.EditorGUIUtilityLabelWidth(28))
                {
                    bSize = EditorGUI.FloatField(new Rect(position.x, position.y, position.width / 2 - 6, position.height), "Size", bSize);
                }
                using (new AmazingAssets.EditorGUIUtility.EditorGUIUtilityLabelWidth(40))
                {
