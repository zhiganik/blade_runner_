...
Shader "Curved_Shapes_Shader_ST"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local CURVEDWORLD_BEND_TYPE_CLASSICRUNNER_Z_POSITIVE CURVEDWORLD_BEND_TYPE_CLASSICRUNNER_X_POSITIVE
